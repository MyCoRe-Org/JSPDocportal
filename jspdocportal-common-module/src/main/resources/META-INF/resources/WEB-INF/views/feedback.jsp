		...
		<div class="ir-box">
          ...
          <c:forEach var="m" items="${it.messages}">
			...
			<form id="feedback-form" action="${applicationScope.WebApplicationBaseURL}do/feedback" accept-charset="UTF-8" method="post"
				...
				<div class="row">
					<label class="col-sm-2 form-label"><fmt:message
				...
				<div class="row">
					<label for="inputName" class="col-sm-2 form-label"><fmt:message
				...
				<div class="row">
					<label for="inputEmail" class="col-sm-2 form-label"><fmt:message
