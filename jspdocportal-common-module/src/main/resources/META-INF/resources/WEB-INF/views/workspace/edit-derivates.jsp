          ...
          <div class="col edit_derivates-content">
            ...
            <input type="hidden" name="mcrobjid" value="${it.mcrobjid}" />
				...
				<div class="card border my-3">
                      ...
                      <div class="row">
                        <div class="col-2">
                          <span class="badge rounded-pill text-bg-secondary">${it.currentVariables.mcrObjectID}</span>
                        </div>
                        <div class="col-8">
                        	<h3>
    					...
    					<x:forEach var="x" select="$doc/mycoreobject/structure/derobjects/derobject">
    						...
    						<div class="card border border-primary m-3">
  							   <div class="card-header text-bg-light">
                                  <div class="row">
                                      <div class="col-2">
                                          <span class="badge rounded-pill text-bg-secondary" style="margin-right:24px; margin-top:6px;">${derID}</span>
                                      </div>
                                      <div class="col-5">
                                        <h4>
