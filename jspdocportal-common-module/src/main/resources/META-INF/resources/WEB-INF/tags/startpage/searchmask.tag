...
<fmt:message var="lblContent" key="Browse.Filter.${mode}.content" />
  ...
  <div class="input-group mb-3">
    <input type="text" class="form-control ir-form-control" 
      v-bind:placeholder="search_placeholder"
      v-model='search_term' v-on:keyup.enter="doSearch()" />
    <button class="btn btn-primary" type="button" v-on:click="doSearch()">
  ...
  <div class="form-check form-check-inline ms-2">
    <input type="radio" class="form-check-input" id="filterField1" v-model="search_field" value="allMeta"> 
  ...
  <div class="form-check form-check-inline">
    <input type="radio" class="form-check-input" id="filterField2" v-model="search_field" value="content">
