      ...
      <xsl:if test="./service/servstates/servstate[@categid='reserved']">
        <div class="card card-info border border-info mb-3">
          ...
          <div class="card-footer">
            ...
            <button class="btn btn-sm ms-1" title="URN kopieren" onclick="navigator.clipboard.writeText(document.getElementById('input_urn').value);"><i class="fas fa-clipboard"></i></button>
            <br />
            ...
            <button class="btn btn-sm ms-1" title="DOI kopieren" onclick="navigator.clipboard.writeText(document.getElementById('input_doi').value);"><i class="fas fa-clipboard"></i></button>
            <br />
            ...
            <button class="btn btn-sm ms-1" title="PURL kopieren" onclick="navigator.clipboard.writeText(document.getElementById('input_purl').value);"><i class="fas fa-clipboard"></i></button>
          </div>
        </div>
      </xsl:if>
    </xsl:if>
