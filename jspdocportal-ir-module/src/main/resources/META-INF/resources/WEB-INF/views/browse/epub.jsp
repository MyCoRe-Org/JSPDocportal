              ...
              <div class="col">
                <div class="input-group input-group-sm">
                  ...
                  <input class="form-control border-secondary" id="filterValue" name="filterValue" placeholder="${lblTerm}"
                         type="text" onkeypress="if (event.key === 'Enter') { JSPDocportalUtil.applyIncludeSearchFilter('epub');}">
                  <div class="input-group-prepend">
                    <button id="filterInclude" class="btn btn-primary" onclick="JSPDocportalUtil.applyIncludeSearchFilter('epub');">
